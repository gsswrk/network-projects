...
# api call
mist_raw = requests.get(
    'https://api.mist.com/api/v1/orgs/{{ org_id }}', auth=(email, p))
mist = mist_raw.json()
...
# remove "." before passing it to the mistsearch function
...
def mainfunct(idf_list_named, mist, user, passwd):
...
if '__name__' == '__main__':
    mainfunct(idf_list_named, mist, user, passwd)
